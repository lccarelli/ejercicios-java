public class Main {
    ...
    public static void main(String[] args){
        ...
        //Pero si queremos aaceder directo por la variable empleado
        //al detalle del objectoGerente no es posible, se pierde el acceso
    ...
    private static void imprimirDetalles(Empleado empleado){
        ...
        if (empleado instanceof Escritor){
            ...
            //para evitar la creacion de variable innecesarias
